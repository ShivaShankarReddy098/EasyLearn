        ...
        >
          <div className="mx-auto max-w-2xl lg:max-w-none">
            ...
            <p className="mx-auto mt-4 max-w-xl text-xl text-gray-600">
              Most of our Courses are limited releases that won&apos;t come
              back. Get your favorite course while they&apos;re in stock.
            </p>
            <a
              href="#"
          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            ...
            <div className="mt-16 space-y-16 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:space-y-0">
              <blockquote className="sm:flex lg:block">
                ...
                <div className="mt-8 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-10">
                  <p className="text-lg text-gray-600">
                    EasyLearn was truly a game-changer and a great guide for me
                    as we brought Dimensional to life.
                  </p>
                  <cite className="mt-4 block font-semibold not-italic text-gray-900">
                    Abhishek Reddy, Bangalore
                  </cite>
                </div>
              </blockquote>
              <blockquote className="sm:flex lg:block">
                ...
                <div className="mt-8 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-10">
                  <p className="text-lg text-gray-600">
                    Nothing just came for review my biggest fan made learning
                    platform
                  </p>
                  <cite className="mt-4 block font-semibold not-italic text-gray-900">
                    L.Messi,Argentina
              ...
              <blockquote className="sm:flex lg:block">
                ...
                <div className="mt-8 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-10">
                  <p className="text-lg text-gray-600">
                    EasyLearn gives you the ability to be persistent. I learned
